...
Или вы можете просто зайти на [сайт](https://traffickrd23.ru/), загруженный на облачный сервер Selectel.
...
#### ● Использован Nginx и сервисы Selectel и Reg.ru для деплоя сайта, подключения доменного имени и SSL сертификата
